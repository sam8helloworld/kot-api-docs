...
func (r ApiGetCompanyRequest) Execute() (*GetCompany200Response, *http.Response, error) {
	return r.ApiService.GetCompanyExecute(r)
}

/*
GetCompany Method for GetCompany
...
*/
func (a *CompanyApiService) GetCompany(ctx context.Context) ApiGetCompanyRequest {
	return ApiGetCompanyRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CompanyApiService) GetCompanyExecute(r ApiGetCompanyRequest) (*GetCompany200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetCompany200Response
	)
