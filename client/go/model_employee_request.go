...
// checks if the EmployeeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployeeRequest{}

// EmployeeRequest struct for EmployeeRequest
...
func (o EmployeeRequest) ToMap() (map[string]interface{}, error) {
