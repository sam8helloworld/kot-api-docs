...
type ApiGetDailyWorkingTimerecordRequest struct {
	ctx context.Context
	ApiService *AttendanceApiService
	date *string
	division *string
...
func (r ApiGetDailyWorkingTimerecordRequest) Date(date string) ApiGetDailyWorkingTimerecordRequest {
	r.date = &date
	return r
}

// 所属コード
func (r ApiGetDailyWorkingTimerecordRequest) Division(division string) ApiGetDailyWorkingTimerecordRequest {
	r.division = &division
	return r
}

// ・true:所属に基づいた勤務データ ・false:出勤先に基づいた勤務データ ・divisionが指定されている場合のみ使用可能
func (r ApiGetDailyWorkingTimerecordRequest) Ondivision(ondivision bool) ApiGetDailyWorkingTimerecordRequest {
	r.ondivision = &ondivision
	return r
}

// 指定されたプロパティをレスポンスに追加
func (r ApiGetDailyWorkingTimerecordRequest) AdditionalFields(additionalFields []string) ApiGetDailyWorkingTimerecordRequest {
	r.additionalFields = &additionalFields
	return r
}

func (r ApiGetDailyWorkingTimerecordRequest) Execute() (*GetDailyWorkingTimerecord200Response, *http.Response, error) {
	return r.ApiService.GetDailyWorkingTimerecordExecute(r)
}
...
指定した年月日の日別打刻データを取得する。
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetDailyWorkingTimerecordRequest
*/
func (a *AttendanceApiService) GetDailyWorkingTimerecord(ctx context.Context) ApiGetDailyWorkingTimerecordRequest {
	return ApiGetDailyWorkingTimerecordRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return GetDailyWorkingTimerecord200Response
func (a *AttendanceApiService) GetDailyWorkingTimerecordExecute(r ApiGetDailyWorkingTimerecordRequest) (*GetDailyWorkingTimerecord200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetDailyWorkingTimerecord200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AttendanceApiService.GetDailyWorkingTimerecord")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
