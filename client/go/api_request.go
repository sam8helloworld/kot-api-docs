...
type ApiGetOvertimesRequest struct {
	ctx context.Context
...
func (r ApiGetOvertimesRequest) AdministratorKey(administratorKey string) ApiGetOvertimesRequest {
	r.administratorKey = &administratorKey
	return r
}

// 指定されたプロパティをレスポンスに追加
func (r ApiGetOvertimesRequest) AdditionalFields(additionalFields []string) ApiGetOvertimesRequest {
	r.additionalFields = &additionalFields
	return r
}

func (r ApiGetOvertimesRequest) Execute() (*GetOvertimes200Response, *http.Response, error) {
	return r.ApiService.GetOvertimesExecute(r)
}

/*
GetOvertimes /requests/overtimes/{date}{?administratorKey,additionalFields}
...
※対象企業が時間外勤務申請を利用できない場合にはエラーとなります。
 ...
 @return ApiGetOvertimesRequest
*/
func (a *RequestApiService) GetOvertimes(ctx context.Context, date string) ApiGetOvertimesRequest {
	return ApiGetOvertimesRequest{
		ApiService: a,
		ctx: ctx,
		date: date,
...
//  @return GetOvertimes200Response
func (a *RequestApiService) GetOvertimesExecute(r ApiGetOvertimesRequest) (*GetOvertimes200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetOvertimes200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RequestApiService.GetOvertimes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/requests/overtimes/{date}"
